...
const EditionDrop = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([EditionDrop.getAbi(), import('./edition-drop-e64edd4d.esm.js')]);
...
const Edition = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Edition.getAbi(), import('./edition-85b1808a.esm.js')]);
...
const Marketplace = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Marketplace.getAbi(), import('./marketplace-bdbb54cf.esm.js')]);
...
const Multiwrap = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Multiwrap.getAbi(), import('./multiwrap-07ff4cec.esm.js')]);
...
const NFTCollection = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([NFTCollection.getAbi(), import('./nft-collection-006a1aa8.esm.js')]);
...
const NFTDrop = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([NFTDrop.getAbi(), import('./nft-drop-c7ced0f3.esm.js')]);
...
const Pack = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Pack.getAbi(), import('./pack-1462ddd3.esm.js')]);
...
const SignatureDrop = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([SignatureDrop.getAbi(), import('./signature-drop-187bcd02.esm.js')]);
...
const Split = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Split.getAbi(), import('./split-47606576.esm.js')]);
...
const TokenDrop = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([TokenDrop.getAbi(), import('./token-drop-d6869beb.esm.js')]);
...
const Token = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Token.getAbi(), import('./token-00fda34a.esm.js')]);
...
const Vote = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Vote.getAbi(), import('./vote-06f87bc1.esm.js')]);
